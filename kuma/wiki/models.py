...
def invalidate_zone_caches(sender, instance, **kwargs):
    ...
    try:
        if instance.zone:
            ...
            DocumentZoneURLRemapsJob().invalidate(instance.locale)
    except DocumentZone.DoesNotExist:
        pass

    # alternatively reset the cache for the zone stack for all of the documents
    # in the document branch
    for document in [instance] + instance.get_topic_parents():
        DocumentZoneStackJob().invalidate(document.pk)
